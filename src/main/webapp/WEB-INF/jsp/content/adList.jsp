...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${basePath}/resources/js/content/adList.js?ver=1"></script>
	</head>
			...
			<div class="right">
				...
				<div class="rightCont">
					...
					<div class="zixun fix">
						...
						<!-- 分页 -->
						<t:page page="${searchParam.page}" jsMethodName="search" prefix="ad" searchKey="${title}"/>
