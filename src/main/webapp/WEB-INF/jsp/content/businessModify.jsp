...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${basePath}/resources/js/common/jquery-1.8.3.js"></script>
		<script type="text/javascript" src="${basePath}/resources/js/common/validation/jquery.validate.js"></script>
		<script type="text/javascript" src="${basePath}/resources/js/common/validation/messages_zh.js"></script>
		<script type="text/javascript" src="${basePath}/resources/js/common/common.js?ver=1"></script>
		<script type="text/javascript" src="${basePath}/resources/js/content/businessModify.js?ver=1"></script>
	</head>
								...
								<td width="30%">
									<select name="category">
										<c:forEach items="${categoryList}" var="item">
											<option value="${item.code}" <c:if test="${item.code eq modifyObj.category}">selected="selected"</c:if>>${item.name}</option>
										</c:forEach>
									</select>
								</td>
							</tr>
