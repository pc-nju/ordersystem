...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="${basePath}/resources/css/pop.css" rel="stylesheet" type="text/css" />
        <link href="${basePath}/resources/css/zTreeStyle/zTreeStyle.css" type="text/css" rel="stylesheet" />
        <link href="${basePath}/resources/css/jquery.validate.css" type="text/css" rel="stylesheet" />
        <link href="${basePath}/resources/css/rmenu.css" type="text/css" rel="stylesheet" />
        <script src="${basePath}/resources/js/common/jquery-1.8.3.js" type="text/javascript"></script>
        <script src="${basePath }/resources/js/common/jquery.ztree.all.js" type="text/javascript"></script>
        <script src="${basePath}/resources/js/common/validation/jquery.validate.js" type="text/javascript"></script>
        ...
        <script src="${basePath}/resources/js/common/common.js?ver=1" type="text/javascript"></script>
        <script src="${basePath}/resources/js/system/auth.js?ver=1" type="text/javascript"></script>
    </head>
    <body style="background: #e1e9eb;">
                	...
                	<form id="userForm">
	                    <table class="x-form-table">
	                        ...
	                        <tr class="line">
	                            ...
	                            <td>
	                                <input type="text" class="normal-input" name="nickName" id="nickName" style="width: 240px;"/>
	                            </td>
	                        </tr>
	                        <tr class="line">
                	...
                	<form id="groupForm">
	                    <table class="x-form-table">
	                        ...
	                        <tr>
	                            <td class="left"></td>
	                            <td class="submit">
	                                <input class="tabSub" type="button" value="提交" onclick="saveGroup1();"/>
	                                <input class="tabSub" type="reset" value="关闭" onclick="closeGroup1();"/>
	                            </td>
	                        </tr>
	                        </tbody>
	                    </table>
	                ...
	                <form id="menuForm">
	                    <table class="x-form-table">
	                        ...
	                        <tr>
	                            <td class="left"></td>
	                            <td class="submit">
	                                <input class="tabSub" type="button" value="提交" onclick="saveMenu1();"/>
	                                <input class="tabSub" type="reset" value="关闭" onclick="closeMenu1();"/>
	                            </td>
	                        </tr>
	                        </tbody>
	                    </table>
	                ...
	                <form id="actionForm">
	                    <table class="x-form-table">
	                        ...
	                        <tr>
	                            <td class="left"></td>
	                            <td class="submit">
	                                <input class="tabSub" type="button" value="提交" onclick="saveAction1();"/>
	                                <input class="tabSub" type="reset" value="关闭" onclick="closeAction1();"/>
	                            </td>
	                        </tr>
	                        </tbody>
	                    </table>
        ...
        <div id="groupMenu" class="rMenu" onmouseout="divOut();" onmouseover="divOver()">
            <ul class="rMenuUi">
                <li class="rMenuLi" onmousemove="move(this);" onclick="initAddGroup1();">新增</li>
                <li class="rMenuLi disabled" onmousemove="move(this);" onclick="modifyOfGroup1();">修改</li>
                <li class="rMenuLi disabled" onmousemove="move(this);" onclick="removeGroup1();">删除</li>
            </ul>
        </div>
        ...
        <div id="menuMenu" class="rMenu" onmouseout="divOut();" onmouseover="divOver()">
            <ul class="rMenuUi">
                <li class="rMenuLi menuClass" onmousemove="move(this);" onclick="initAddMenu1();">新增菜单</li>
                <li class="rMenuLi disabled menuClass" onmousemove="move(this);" onclick="initAddAction1();">新增动作</li>
                <li class="rMenuLi disabled" onmousemove="move(this);" onclick="modifyOfMenu1();">修改</li>
                <li class="rMenuLi disabled" onmousemove="move(this);" onclick="removeOfMenu1();">删除</li>
            </ul>
        </div>
        ...
        <table border="0" style="height:550px" align="left" width="100%">
            ...
            <tr>
                <td></td>
                <td align="right"><input type="button" class="tabSub" value="分配用户组" onclick="assignGroup1();"/></td>
                <td align="right"><input type="button" class="tabSub" value="分配菜单" onclick="assignMenu1();"/></td>
            </tr>
        </table>
    </body>
</html>