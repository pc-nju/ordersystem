...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
	    ...
	    <script src="${basePath}/resources/js/common/json.js" type="text/javascript"></script>
	    <script src="${basePath}/resources/js/system/index.js" type="text/javascript"></script>
	</head>
	<body>
			...
			<div class="wishlistBox" style="display:none;left:550px;top:200px;">
				<div class="personRigTop persongBgimg" style="height:200px;width:480px;">
					...
					<div class="persongRigCon">
						<form id="passwordEditForm" action="#" method="post">
							<table class="x-form-table">
								...
								<tr>
									<td class="left"></td>
									<td class="submit">
										<input id="submitVal" class="tabSub" value="提交" onclick="modifyPassword();" type="button"/>
		        ...
		        <div class="iheader">
		            ...
		            <div style="height: 44px;">
		                ...
		                <div class="h_info">
							...
							欢迎您！${user.nickName} &nbsp; 当前时间：<label id="currentTime"></label>&nbsp;&nbsp;&nbsp;&nbsp;
